	...
	return (
		<main>
			<div className={styles["executive-center-dashboard-outline"]}>
				...
				<div className={styles["main-home-link"]}>
				...
				<div className={styles["overview-of-clinic-operations"]}>
				...
				<div className={styles["zk-nurse-call-system"]}>
					<h3 className={styles["h3"]}>ZKR Nurse Call System</h3>

					<div className={styles["nurse-call-data"]}>
					...
					<div className={styles["nurse-call-history"]}>
					...
					<div className={styles["zk-system-status"]}>
				...
				<div className={styles["ge-healthcare-medical-imaging"]}>
					<h3 className={styles["h3"]}>GE Healthcare Medical Imaging</h3>

					<div className={styles["medical-imaging-data"]}>
					...
					<div className={styles["ge-healthcare-system-status"]}>
				...
				<div className={styles["masimo-patient-monitoring"]}>
					<h3 className={styles["h3"]}>Masimo Patient Monitoring</h3>

					<div className={styles["patient-monitoring-data"]}>
					...
					<div className={styles["masimo-system-status"]}>
